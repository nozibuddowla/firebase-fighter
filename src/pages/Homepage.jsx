...
const Homepage = () => {
  const handleNotify = () => {
    toast.success("🎉 You will be notified when the homepage is ready!", {
      position: "top-center",
      autoClose: 3000,
      theme: "colored",
    });
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-linear-to-br from-purple-300 via-purple-500 to-purple-300 text-center">
      ...
      <p className="mt-5 text-lg text-white/90 animate-pulse">
        Stay tuned! We are crafting something amazing for you ✨
      </p>
      ...
      <div className="absolute bottom-6 text-black text-sm animate-bounce">
        Developed by <span className="font-bold">no one</span>
      </div>
    </div>
  );
};
